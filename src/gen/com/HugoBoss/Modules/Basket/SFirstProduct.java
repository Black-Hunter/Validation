 ...
 */
public class SFirstProduct extends AbstractWebDriverModule
{
    ...
    protected void doCommands(final String...parameters) throws Exception
    {
        ...
        storeText("css= .product-stage__control-item__selcted-size", "FirstProductSize");
        storeText("css= .product-stage__headline", "FirstProductName");
        storeText("css= div.product-stage__control-item:nth-child(1) > p:nth-child(1)", "FirstProductColor");
        storeEval(resolve("\"${FirstProductColor}\".toUpperCase();"), "FirstProductColor");
        storeText("css= .product-price--price-sales", "FirstProductPrice");
